...
<?php
	...
	class Rooms extends DBConnection{
		...
		function insert_roomreservation($datereserved, $checkin, $checkout, $numofdays, $roomid, 
                $userid){
			$query = "INSERT INTO roomreserve (datereserved, checkin, checkout, numofdays, roomid, 
                userid)
				VALUES (\"".$datereserved."\", \"".$checkin."\", \"".$checkout."\", 
