...
<html>
    ...
    <body>
        ...
        <div class="registerstatement">
            <p align="center" class="registerstatement">CREATE AN ACCOUNT</p>
        </div>

        <div class="registerbody">
            <div class="registerbodystatement">
                <p align="center" class="registerbodystatement">
                    Register with us to quickly make, access and change your bookings, 
                    plus see all your past reservations. Creating an account takes hardly 
                    any time at all.
                </p>
            </div>
            <form action="" method="post" class="registerform">
                <div class="registerform">
                    <div class="registerlogindetails">
                        <p align="left" class="registerlogindetails">
                            LOGIN DETAILS
                        </p>
                    ...
                    <div class="registeraddress">
                        <p align="left" class="registeraddress">
                            ADDRESS
                        </p>
                        ...
                        <div class="registerline2">
                            <li class="registerline2">Address Line 2</li>
                            <input type="text" class="registerline2" id="registerline2" name="registerline2" placeholder="Address line 2"/><br/>
                        </div>                        
                        <div class="registerpostalcode">
                            <li class="registerpostalcode">Postal Code</li>
                            <input type="text" class="registerpostalcode" id="registerpostalcode" name="registerpostalcode" placeholder="Postal Code"/><br/>
                        </div>                    
                    </div>
                    <div class="registercontactinfo">
                        <p align="left" class="registercontactinfo">
                            Contact Information
                        </p>
